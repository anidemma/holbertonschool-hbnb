...
class ReviewList(Resource):
    ...
    def post(self):
        ...
        elif ('rating' not in review_data):
            return {'message': 'Missing rating'}, 400
        elif ('user_id' not in review_data):
            return {'message': 'Missing user'}, 400
        elif ('place_id' not in review_data):
            return {'message': 'Missing place'}, 400
